...
The bot's profile page ("Open App") and the channel post's `t.me/<bot>?startapp=` links are _not_ set
from here: both come from the main Mini App being enabled in BotFather (see
